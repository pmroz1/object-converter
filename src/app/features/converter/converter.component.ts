...
@Component({
  ...
  template: `
    <div
      class="card flex flex-col items-center justify-center h-full w-full m-10"
    >
      <h1 class="text-7xl font-bold mb-4">JSON Object Converter</h1>
      <p class="mb-4 text-3xl">Convert your objects easily!</p>
      <app-text-input-output-area [inputTypes]="availableInputTypes" [outputTypes]="availableOutputTypes"></app-text-input-output-area>
    </div>
  `,
  styles: '',
